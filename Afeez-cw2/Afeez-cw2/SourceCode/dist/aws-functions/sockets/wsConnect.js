...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, ddbClient.send(new lib_dynamodb_1.PutCommand(params))];
            case 2:
                _a.sent();
            ...
            case 3:
                err_1 = _a.sent();
                console.error(JSON.stringify(err_1));
                return [2 /*return*/, {
                        statusCode: 500,
                        body: "Server Error: " + JSON.stringify(err_1)
                    }];
...
//# sourceMappingURL=wsConnect.js.map